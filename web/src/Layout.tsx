import { LayoutDashboard, Bot, Laptop, FileCode, Settings, Menu, GraduationCap, Disc, Languages, X, Network, Layers } from "lucide-react";
...
export function Layout() {
    ...
    const navItems = [
        ...
        { icon: Layers, label: t("common.batches"), path: "/batches" },
