...
import { ArrowLeft, Terminal, RefreshCw, Power, GitBranch, Save, Activity, Plus, X, Lightbulb, Trash2, Edit2, Network } from "lucide-react";
...
export function LaptopDetail() {
    ...
    const handleRename = async () => {
        ...
        try {
            ...
            success(t("robotDetail.renamed") || "Laptop renamed");
        } catch (err) {
